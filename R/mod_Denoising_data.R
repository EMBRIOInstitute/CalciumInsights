...
mod_Denoising_data_server <- function(id){
  moduleServer( id, function(input, output, session){
    ...
    "),
        HTML("
      <p style='text-align: justify;'>
        <strong>Example Data:</strong> You choose the data you want to analyze.
      </p>
    "),
        HTML("
      <p style='text-align: justify;'>
        - 'No': You must load your own data to be analyzed.
      </p>
      <p style='text-align: justify;'>
        - 'Yes': You will analyze a sample dataset that is provided by default.
      </p>
    "),
